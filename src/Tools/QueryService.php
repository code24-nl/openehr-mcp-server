...
readonly final class QueryService extends AbstractApiService
{
     ...
     * @param int|null $fetch Optional pagination fetch/limit
     * @return array<string, mixed> The result of the query
     */
    #[McpTool(name: 'openehr_query_adhoc')]
    public function adhoc(string $aql, ?int $offset = null, ?int $fetch = null): array
    {
     ...
     * @param string|null $version Query version (e.g., 1.0.0)
     * @param array<string,mixed>|null $parameters Parameters map for the query (will be sent as JSON)
     * @return array<string, mixed> The result of the query
     */
    #[McpTool(name: 'openehr_query_stored_execute')]
    public function stored(string $name, ?string $version = null, ?array $parameters = null): array
    {
        $this->logger->debug('called ' . __METHOD__, func_get_args());
        try {
